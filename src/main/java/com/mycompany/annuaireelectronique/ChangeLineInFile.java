...
public void deleteALine(String fileName, String newLine, int lineNumber) {
        String content = new String();
        String editedContent = new String();
        content = readFile(fileName);
        writeToFile(fileName, editedContent);
...
private static void writeToFile(String file, String content) {
    ...
    try (Writer writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file), "utf-16 LE"))) {
